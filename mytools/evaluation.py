...
def main(): 
    ...
    test_annotations    = 'mydatas/test.txt'
    ...
    input_names = ["x"]
    output_names = ["y"]
    inp = torch.randn(1, 3, 160, 320)  ##(1,3,h,w)
    torch.onnx.export(model, inp, "./shuff230824.onnx", opset_version=11, verbose=True, input_names=input_names, output_names=output_names)
    # #---
    ...
    # torch.jit.save(mod, "G:\\PNNX\\pnnx-20230524-windows\\van230704zq.pt")
    # #---
    ...
    test_dataset = Mydataset(test_datas, val_pipeline, no_pipeline, 0)
